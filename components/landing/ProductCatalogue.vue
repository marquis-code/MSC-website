...
// import unicureIbutenImg from '@/assets/unicure-ibuten.jpg'
// import plumalDsImg from '@/assets/plumal-ds.jpg'
// import lutherminImg from '@/assets/luthermin.jpg'
// import curefenacImg from '@/assets/curefenac.jpg'
// import aluminocureImg from '@/assets/aluminocure.jpg'
// import dexacureImg from '@/assets/dexacure.jpg'
import HeroImage from '@/assets/img/hero-image-2.jpeg'
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mb-12">
                <div class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium mb-4"
                    style="background-color: hsl(var(--healthcare-blue) / 0.1); color: hsl(var(--healthcare-blue))">
                    <Icon icon="mdi:package-variant-closed" class="w-4 h-4 mr-2" />
                    Product Catalogue
                </div>
                <h2 class="text-3xl md:text-4xl font-bold mb-4">
                    Quality <span style="color: hsl(var(--healthcare-blue))">Pharmaceutical</span> Products
                </h2>
                <p class="text-xl text-muted-foreground max-w-3xl mx-auto">
                    Browse our comprehensive range of verified pharmaceutical products available through our
            ...
            <div class="max-w-md mx-auto mb-8">
                <div class="relative">
                    ...
                    <Input placeholder="Looking for something specific? Type a drug name..." v-model="searchTerm"
                        class="pl-10" />
                </div>
            </div>
            ...
            <div class="flex flex-wrap justify-center gap-2 mb-8">
                <Button v-for="category in categories" :key="category" rounded
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <template v-if="filteredProducts.length > 0">
                    <div v-for="product in filteredProducts" :key="product.id"
                        class="group rounded-2xl border border-border/50 hover:border-primary/30 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 bg-white">
                        <!-- Image -->
                ...
                <template v-else>
                    <div class="col-span-full text-center py-16">
                        <div class="rounded-full w-24 h-24 flex items-center justify-center mx-auto mb-6"
            ...
            <div class="text-center mx-auto w-max">
                <Button size="lg" class="hover:scale-105 transition-el duration-300 w-max" asChild>
